...
and returns only the films that have both "Trailers" and "Deleted Scenes" as their special feature. special_features is the text[] type.
It represents a one-dimensional array of values, where each value is of the text data type.
...
The desired output should look like this:
     ...
     @> USING in Postgres for work with arrays
    @> - contains

select film_id, title, special_features
from film
where special_features @> array['Trailers', 'Deleted Scenes']
order by title desc, film_id asc;