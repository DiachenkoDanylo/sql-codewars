...
-- PostgreSQL has built-in network functions for the inet type that make this one is straightforward:
--
-- network(inet) - returns the network address
-- broadcast(inet) - returns the broadcast address
-- host(inet) - converts to text representation without the netmask
-- text(inet) - converts to text with the netmask
